...
[![NPM Package](https://img.shields.io/npm/v/fourtwentyjs-abi.svg?style=flat-square)](https://www.npmjs.org/package/fourtwentyjs-abi)
[![Build Status](https://img.shields.io/travis/420integrated/fourtwentyjs-abi.svg?branch=master&style=flat-square)](https://travis-ci.org/420integrated/fourtwentyjs-abi)
[![Coverage Status](https://img.shields.io/coveralls/420integrated/fourtwentyjs-abi.svg?style=flat-square)](https://coveralls.io/r/420integrated/fourtwentyjs-abi)
[![js-standard-style](https://img.shields.io/badge/code%20style-standard-brightgreen.svg)](http://standardjs.com/)
[![Discord][discord-badge]][discord-link]


Module implementing the [420coin ABI](https://github.com/420integrated/go-420coin/wiki/wiki/420coin-Contract-ABI) in Javascript. Can be used with RPC libraries for communication or with fourtwentyjs-vm to implement a fully fledged simulator.
...
Example code:
```js
var abi = require('fourtwentyjs-abi')
...
See our organizational [documentation](https://420integrated/wiki/fourtwentyjs) for an introduction to `FourtwentyJS` as well as information on current standards and best practices.
