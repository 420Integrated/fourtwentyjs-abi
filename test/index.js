...
// Official test vectors from https://github.com/420integrated/go-420coin/wiki/wiki/420coin-Contract-ABI
...
describe('utf8 handling', function () {
  it('should encode latin and extensions', function () {
    var a = abi.rawEncode([ 'string' ], [ '420coin számítógép' ]).toString('hex')
